...
$(function () {
    ...
    var navContent_rightLink = [
        {
            "linkUrl": "https://docs.google.com/forms/d/1_mQBm0LQjK_2mmnWakrlVcFkVuiBHA_NwrVXUH2DeEE/edit?hl=zh-tw",
            "words": "填寫表單",
            "target": ""
        },
        {
    ...
    function spScrollRightNav() {
        ...
        navContent_rightLink.forEach(function (el) {
            /*
    ...
    function bindNav($winWt) {
        ...
        arrTitle.forEach(function (el, index) {
            if ($winWt > $screenChangeWt && docScrollTop - el.offsetTop >= 0) {
                targetIndex = index + navRightLinkLength;
            }

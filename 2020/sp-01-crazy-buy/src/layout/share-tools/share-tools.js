...
(function () {
    ...
    html_fb = "<a href='" + href_fb + "' title='分享到fackebook' class='share__btn btn--fb'><img src='fb.png' alt='分享到fackebook'/></a>";
    ...
    html_line = "<a href='" + html_line + "' title='分享到LINE' class='share__btn btn--line'><img src='line.png' alt='分享到LINE'/></a>";

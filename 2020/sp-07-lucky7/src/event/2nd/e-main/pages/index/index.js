...
//- 載入資料
import { discountCouponGoods } from 'event/2nd/e-main/components/slider-section-2-coupon/slider-section-2-coupon.js'
// import { initdailyGoods } from 'event/2nd/e-main/components/slider-section-1-collect/slider-section-1-collect.js'
// ig
import { initSliderEvent } from 'event/2nd/e-main/components/slider-section-1-ig/slider-section-1-ig.js'
import { initSlider20offGoods } from 'event/2nd/e-main/components/slider-section-2-coupon/slider-section-2-coupon.js'
// import { getTabGoodsData } from 'event/2nd/e-main/components/tab-slider-section/tab-slider-section.js'
import { initBuildTab } from 'event/2nd/e-main/components/tab-slider-section/tab-slider-section.js'
import { initSliderTabLoad } from 'event/2nd/e-main/components/tab-slider-section/tab-slider-section.js'
// import { initBuildTab } from 'event/2nd/e-main/components/tab-section/tab-section.js'
// import { initSliderBnPrevent } from 'event/2nd/e-main/components/bn-event-prevent/bn-event-prevent.js'
import { initSliderBnHot } from 'event/2nd/e-main/components/bn-event-hot/bn-event-hot.js'
// ==========================================================================
// page js
// ==========================================================================

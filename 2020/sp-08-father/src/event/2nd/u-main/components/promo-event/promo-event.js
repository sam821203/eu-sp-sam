...
export var initPromoBuildByCustomTime = [
...
function addAnchorLink(i){
  ...
  var anchorChangeLink = document.getElementById('promoAnchor');
...
function addImgSrc(i) {
  ...
  var imgChangeSrc2 = document.getElementById('promoImg2');

  imgChangeSrc2.src = imgData[i];
}

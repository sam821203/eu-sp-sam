...
export var initSliderDynamic_2 = buildSliderContent();

function buildSliderContent() {
    var sliderContainer = document.querySelector('#sliderDynamic_2 .swiper-wrapper');
...
function sliderDynamicReady() {
    var sliderDynamic_2 = new Swiper('#sliderDynamic_2', {
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
        },
        grabCursor: true,
        init: isNeedSlider('#sliderDynamic_2', 3),
        initialSlide: Math.floor(Math.random() * document.querySelectorAll('#sliderDynamic_2 .swiper-slide').length),
        lazy: {
            loadPrevNext: true,
        },
        loop: true,

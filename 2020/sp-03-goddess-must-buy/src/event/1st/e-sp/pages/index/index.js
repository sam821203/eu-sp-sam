...
// ==========================================================================
//-import { bgDecoration } from 'event/1st/e-sp/components/background-decoration/background-decoration'

//-import { initCanvasEffect } from 'event/1st/e-sp/components/canva-effect/canva-effect.js'
//-import { initChangePromoAnchor } from 'event/1st/e-sp/components/promo-event-full-screen/promo-event.js'
//-import { initSliderSmall } from 'event/1st/e-sp/components/hero-small-slider/hero-small-slider.js'
// import { initSliderGoodsFlip } from 'event/1st/e-sp/components/goods-slider-flip/goods-slider-flip.js'
// import { initSliderPurchase } from 'event/1st/e-sp/components/purchase-section/purchase-section.js'
//-import { initSliderScrollX } from 'event/1st/e-sp/components/scroll-x-section/scroll-x-section.js'
//-import { initBuildTab } from 'event/1st/e-sp/components/tab-section/tab-section.js'
//-import { initBuildCountDown } from 'event/1st/e-sp/components/countdown-section/countdown-section.js'
//-import { initBuildCountDown_2 } from 'event/1st/e-sp/components/bn-event-2/bn-event-2.js'
//-import { initSliderSpecial } from 'event/1st/e-sp/components/bn-special/bn-special.js'

// import { initSliderGoods } from 'event/1st/e-sp/components/goods-slider/goods-slider.js'
// import { initSliderHot } from 'event/1st/e-sp/components/two-medium-slider/two-medium-slider.js'
// import { initSliderBank } from 'event/1st/e-sp/components/bank-section/bank-section.js'
// import { initSliderEvent } from 'event/1st/e-sp/components/bn-event/bn-event.js'

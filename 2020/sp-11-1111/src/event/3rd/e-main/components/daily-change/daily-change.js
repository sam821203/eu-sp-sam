...
function dailyChange() {
  ...
  // var dailyDateArray = createDateArray("2020/10/26 10:00:00", 32) // 第一波
  var dailyDateArray = createDateArray("2020/11/3 10:00:00", 24) // 第二波
...
function addDailyImgSrc(i) {
  // TODO: 超過n+1天就退出(因為要倒數所以n日的日期陣列要加一天成為n+1)，依照活動時間更改
  // if (!dailyData || i >= 32) return false; // 第一波
  if (!dailyData || i >= 14) return false; // 第二、三波
  ...
  // 第二、三波
  dailyChangeImg.src= "https://www.etmall.com.tw/XML/content/DMSetting/Final/202011/SP_1116729/daily-item-" + (i + 9) + ".png";

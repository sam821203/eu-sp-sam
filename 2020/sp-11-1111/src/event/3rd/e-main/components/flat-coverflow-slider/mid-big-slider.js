...
export var initSliderMidBig = detectApp(window.addEventListener('load', sliderMidBigReady), sliderMidBigReady);
...
function sliderMidBigReady() {
  var sliderMidBig = new Swiper('#sliderMidBig', {
    ...
    loop: true,
    navigation: {
      nextEl: '#sliderMidBigNext',
      prevEl: '#sliderMidBigPrev',
    },
    on: {
      setTranslate: function () {
        ...
        for (var i = 0; i < slides.length; i++) {
          ...
          // 旋轉
          slide.transform('rotate(' + progress * -15 + 'deg)');

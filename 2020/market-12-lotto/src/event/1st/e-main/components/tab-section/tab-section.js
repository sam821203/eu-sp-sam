...
function buildTab() {
    ...
    var sencondTab = Array.apply(null, document.querySelectorAll('.content__box'));
    sencondTab.forEach(function (el, index) {
        var tabItems_2 = Array.apply(null, el.querySelectorAll('.js--tab__item_sub'));
        var contentBox_2 = Array.apply(null, el.querySelectorAll('.js--content__box_sub'));

        // 預設
        addActive(contentBox_2, 0)

;(function ($) {
    ...
    function buildVersion() {
        ...
        var cssLink = $('<link type="text/css" href="http://www.etmall.com.tw/XML/content/DMSetting/Final/201610/SP_1048784/css/sp-common1129.css?' + days + min + '" rel="stylesheet">');

        //var cssLink = $('<link type="text/css" href="css/sp-common1129.css?' + days + min + '" rel="stylesheet">');

        $head.append(cssLink);

        $head.append($.getScript("http://www.etmall.com.tw/XML/content/DMSetting/Final/201610/SP_1048784/js/sp-script1129.js"));
        //$head.append($.getScript("js/sp-script1129.js"));

...
function loading() {
    function preloading () {
        ...
        var overlayStyleAttr = {
            ...
            'height': '100%',
            // custom
            'background': '#04017F radial-gradient(circle, #ff8a88, #b03030)',
        }
    ...
    var opening = function() {
        ...
        var openItem2 = document.getElementById('openItem2');
        var openItem3 = document.getElementById('openItem3');
        ...
        if (timer) {
            ...
            setTimeout(function(){
                ...
                openItem.classList.add('animation');
                openItem2.classList.add('animation');
                openItem3.classList.add('animation');

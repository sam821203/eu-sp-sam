...
(function(root, factory) {
    ...
    Pageable.prototype._wheel = function(e) {
        ...
        if (this.events.wheel && !this.scrolling && lethargyState) {
            var index = this.index;
            var oldIndex = this.index;
            var inc = 0 < e.deltaY;
...
/*
 lethary.js
    solve: 使用筆電或 Mac 滑鼠滾動頁面時化造成慣性滑動，導致持續滑動好幾頁。
 */
// import { Lethargy } from "lethary"
...
var checkScroll = function (e) {
    lethargyState = lethargy.check(e);
}

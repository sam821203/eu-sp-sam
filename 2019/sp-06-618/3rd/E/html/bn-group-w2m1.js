...
window.dataSp = [
    ...
    {
        webHref: "https://www.etmall.com.tw/p/74938",
        appHref: "etmall://open?pgid=53&eid=74938",
        imgSrc: "bn-group-e-02.png",
        intro: "任選2件79折"
    },
    {
        webHref: "https://www.etmall.com.tw/XML/content/DMSetting/Final/201906/SP_1108232/w/index.html",
        appHref: "etmall://open?pgid=44&url=https%3a%2f%2fwww.etmall.com.tw%2fXML%2fcontent%2fDMSetting%2fFinal%2f201906%2fSP_1108232%2fm%2fapp.html&t=%e6%94%9d%e9%83%8e%e5%87%ba%e6%b2%92%ef%bc%81%7cETMall%e6%9d%b1%e6%a3%ae%e8%b3%bc%e7%89%a9%e7%b6%b2",
        imgSrc: "bn-group-e-03.png",
        intro: "指定相機送1000"
    },
    {
        webHref: "https://www.etmall.com.tw/c2/107790",
        appHref: "etmall://open?pgid=8&cd=107790",
    ...
    {
        webHref: "https://www.etmall.com.tw/XML/content/DMSetting/Final/201906/SP_1108183/w/index.html",
        appHref: "etmall://open?pgid=44&url=https%3a%2f%2fwww.etmall.com.tw%2fXML%2fcontent%2fDMSetting%2fFinal %2f201906%2fSP_1108183%2fm%2fapp.html&t=%e6%98%a5%e5%ad%a3datingwithspring%e7%b5%95%e6%ae%ba%e7%b4%84%e6%83%a0_E %e2%94%82ETMall%e6%9d%b1%e6%a3%ae%e8%b3%bc%e7%89%a9%e7%b6%b2",
...
window.dataSp__carousel2 = [
    ...
    {
        webHref: 'https://www.etmall.com.tw/XML/content/DMSetting/Final/201906/SP_1108205/w/index.html',
        appHref: 'etmall://open?pgid=44&url=https%3a%2f%2fwww.etmall.com.tw%2fXML%2fcontent%2fDMSetting%2fFinal%2f201906%2fSP_1108205%2fm%2fapp.html',
        imgSrc: 'bn-group-c2-e-06.jpg',
        intro: '資訊',
    },
    {
        webHref: 'https://www.etmall.com.tw/c3/131797',
        appHref: 'etmall://open?pgid=8&cd=131797',
...
// 發燒強打星
window.data__HotStar = [
    // ====================================== 手動編輯區開始 ======================================
    {
        webHref: "https://www.kingkong.com.tw/",
        appHref: "https://www.kingkong.com.tw/",
        imgSrc: "host0617-1.png",
        intro: "617",
        id: "617live01",
    },
    {
...
// 發燒強打星
makeSliderDOM("hotStarW2m1", data__HotStar, 1);
var hotStarW2m1 = $('#hotStarW2m1');
var btnPrevHotStar = $('#btnPrevHotStar');
var btnNextHotStar = $('#btnNextHotStar');
...
hotStarW2m1.slick({
    ...
    autoplay: true,
    autoplaySpeed: 4000,
    prevArrow: btnPrevHotStar,
    nextArrow: btnNextHotStar,
    responsive: [{
        breakpoint: 768,
        settings: {
            slidesToShow: 1,
...
function makeSliderDOM(wrapId, dataSrc, target) {
...
function changeImage(wrapId, dataSrc) {
    var eventZone = document.getElementById(wrapId);
    var todayDate = (dateNowMonth + 1) * 100 + dateNowDate;
    dataSrc.forEach(function (el) {
        var dataID = el.id;
        if (dataID.split('live')[0] == '617' && todayDate > '617') {
            hotStarW2m1.slick('slickRemove', 0);
        }

        else if (dataID.split('live')[0] == '618' && todayDate > '618') {
            hotStarW2m1.slick('slickRemove', 0);
            var $winWt = $(document).width();
            if($winWt > 768) {
                $(".bn-group__wrap--w2m1.hot__star .bn-group__zone").css("backgroundImage","url(live.png)");
            }
        }
...
changeImage("hotStarW2m1", data__HotStar);
spTimeLimit();
...
(function ($) {
    ...
    // 手風琴
    $('.accordion > li a').addClass('active').next().slideDown();  // 預設全打開
    $('.accordion a.accordion-title').click(function (j) {
        ...
        // $(this).closest('.accordion').find('.detail').not($dropDown).slideUp();  // 關閉除了自己以外的其他
    ...
    //  測試網址
    // var urlHref = "https://www.etmall.com.tw/XML/content/DMSetting/Final/201902/SP_1107207/w/index.html?regist=eForm02+eForm03";
    ...
    $(document).on("click", ".open-comment", function () {
        ...
        $(this).parents("#sp_loginForm").find(".rgt__form__outline").addClass("max-width-100");
    })
    ...
    $(document).on("click", ".finish__btn", function () {
        closeOverlay();
    });
    function closeOverlay() {
        $(".overlay-mask").remove();
        $(".overlay").removeClass("overlay-open").css('display','none').addClass("overlay-animate");
        $(".rgt__form__outline").removeClass("max-width-100");
    }

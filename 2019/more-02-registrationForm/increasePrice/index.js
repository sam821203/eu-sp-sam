...
(function ($) {
    ...
    $(document).on("click", ".open-comment", function () {
        var $overlayEvents = $(this).parents(".title__wrap").find(".overlay");
    ...
    function closeOverlay() {
        $(".overlay-mask").remove();
        $(".overlay").removeClass("overlay-open").fadeOut(0).addClass("overlay-animate");

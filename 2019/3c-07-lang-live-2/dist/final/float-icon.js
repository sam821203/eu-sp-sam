// 設定連結網址(不需要的網址需要移除內容)
var promoLink = 'https://www.facebook.com/ETMall/videos/881888805523237?s=100001121425300&v=e&sfns=mo';
var mobileLink = 'https://www.facebook.com/ETMall/videos/881888805523237?s=100001121425300&v=e&sfns=mo';
var appLink = 'etmall://open?pgid=45&url=https%3A%2F%2Fwww.facebook.com%2FETMall%2Fvideos%2F881888805523237%3Fs%3D100001121425300%26v%3De%26sfns%3Dmo';

mobileLink ? mobileLink : promoLink;
appLink ? appLink : promoLink;

var floatScript = document.querySelectorAll("script");
var scriptIndex = '';
// ==========================================================================
...
// ==========================================================================
function addIDName() {
    console.log('floatScript', floatScript);
    floatScript.forEach(function (el, index) {
        if (el.src.indexOf("float-icon.js") > -1) {
            scriptIndex = index;
        }
    });
    var scriptTarget = floatScript[scriptIndex];
    scriptTarget.id = "scriptIconFloat";
}

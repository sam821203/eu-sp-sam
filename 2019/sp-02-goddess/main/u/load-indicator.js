...
function loading() {
	function preloading () {
		...
		var overlayStyleAttr = {
			...
			'height': '100%',
			// custom
			'background': '#ffaf92 linear-gradient(162deg, #ffaf92 15%, #fddcc9 50%, #fce9c7 100%)',
			'transition': '0.5s all',
		}
	...
	var opening = function() {
		...
		var overlayStyle = document.getElementById('overlayStyle');
  		...
  		if (timer) {
	 		...
	 		function underOpening(){
	 			// overlay go out style
			 	overlay.style.opacity = 0;
			 	// overlay off than open the opening animation
		  		document.body.classList.add('overlay--off');		 			
	 		}

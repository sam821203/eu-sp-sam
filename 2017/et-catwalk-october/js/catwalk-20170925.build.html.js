...
$(function(){
    function buildMainProduct() {
        ...
        productHtml +=    '<a href="' + firstData.url + '" class="product__info" title="' + firstData.name + '">'
            ...
            switch (i) {
                case 0:
                    ...
                    for (j = 0; j < otherData[0].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[0].data[j].url + '" class="product__info" title="' + otherData[0].data[j].name + '">'
                ...
                case 1:
                    ...
                    for (j = 0; j < otherData[1].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[1].data[j].url + '" class="product__info" title="' + otherData[1].data[j].name + '">'
                ...
                case 2:
                    ...
                    for (j = 0; j < otherData[2].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[2].data[j].url + '" class="product__info" title="' + otherData[2].data[j].name + '">'
                ...
                case 3:
                    ...
                    for (j = 0; j < otherData[3].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[3].data[j].url + '" class="product__info" title="' + otherData[3].data[j].name + '">'
                ...
                case 4:
                    ...
                    for (j = 0; j < otherData[4].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[4].data[j].url + '" class="product__info" title="' + otherData[4].data[j].name + '">'
                ...
                case 5:
                    ...
                    for (j = 0; j < otherData[5].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[5].data[j].url + '" class="product__info" title="' + otherData[5].data[j].name + '">'
                ...
                case 6:
                    ...
                    for (j = 0; j < otherData[6].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[6].data[j].url + '" class="product__info" title="' + otherData[6].data[j].name + '">'
                ...
                case 7:
                    ...
                    for (j = 0; j < otherData[7].data.length; j++) {
                        ...
                        productHtml += '<a href="' + otherData[7].data[j].url + '" class="product__info" title="' + otherData[7].data[j].name + '">'

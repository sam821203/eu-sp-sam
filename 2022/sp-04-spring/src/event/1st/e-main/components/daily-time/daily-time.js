...
function scrollDailyTime() {
  var scrollItem = document.getElementById( 'decorDailyTime' );
  var scrollItem2 = document.getElementById( 'decorDailyTime2' );

  window.addEventListener( "scroll", function () {
    var scrollPercentage = getScrollPercentage( scrollItem2, 0, 0.5 );

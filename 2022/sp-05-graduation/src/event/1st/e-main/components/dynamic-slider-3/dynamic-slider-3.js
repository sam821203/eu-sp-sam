...
export var initDynamicSlider3 = [
  buildDynamicSlider3Content(),
  ScrollDynamicSlider(),
];

function buildDynamicSlider3Content () {
  var swiperWrapper = document.querySelector( '#dynamicSlider3Block .swiper-wrapper' );
...
function dynamicSlider3Ready() {
  var dynamicSlider = new Swiper('#dynamicSlider3Block', {
    // autoplay: {
    //   delay: 2000,
...
function ScrollDynamicSlider() {
  var scrollItem = document.getElementById( 'decorDynamic3Left' );
  var scrollItem2 = document.getElementById( 'decorDynamic3Right');
  var scrollTitle = document.getElementById( 'dynamic3Title');

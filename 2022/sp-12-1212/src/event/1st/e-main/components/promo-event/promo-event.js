...
function chooseRandomPromoItem() {
  ...
  promoItems[chooseItemIndex].classList.add(
...
function ScrollPromoEvent() {
  ...
  var scrollItem3 = document.getElementById("promoEventRight2");

// import {*} from 'https://media.etmall.com.tw/sp/12496/index.html'
import SimplexNoise from 'simplex-noise';
// import * as THREE from '../lib/three.module.js';
// import THREE from 'https://cdnjs.cloudflare.com/ajax/libs/three.js/103/three.min.js'
...
const drawRadialGradation = function (ctx, canvasRadius, canvasW, canvasH) {
    ctx.save();
...
const makeRoughGround = function (mesh) {
    const time = Date.now();
...
const init = function () {
    ...
    scene.fog = new THREE.Fog(0xFFFFFF, 0, minRange * 3);

...
function scrollTabSection2() {
  ...
  var scrollItem2 = document.getElementById( 'decorTab2Right1' );
  var scrollItem3 = document.getElementById( 'decorTab2Right2' );
  ...
  window.addEventListener( "scroll", function () {
    ...
    scrollItem3.style.transform = 'translateY(' + pos + '%)';
...
function buildTab2(){
  ...
  var tabContentBlock = document.getElementById('tabContentBlock2');
...
function sliderTabReady(index) {
  var index = index || 0;
  var arrayTabContents = Array.apply(null, document.querySelectorAll('.tab__slider2'));
...
function buildSliderContent(){
  if(!(dataTabSec1 && dataTabSec2 && dataTabSec3 && dataTabSec4 && dataTabSec5 && dataTabSec6)) return false;

  var dataArray = [dataTabSec1, dataTabSec2, dataTabSec3, dataTabSec4, dataTabSec5, dataTabSec6];
  var sliderContainerArray = Array.apply(null, document.querySelectorAll('#tabContentBlock2 .swiper-wrapper'));

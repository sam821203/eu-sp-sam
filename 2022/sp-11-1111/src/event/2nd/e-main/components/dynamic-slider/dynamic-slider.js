...
function scrollDynamicSlider() {
  var scrollItem = document.getElementById( 'decorDynamicLeft1' );
  var scrollItem2 = document.getElementById( 'decorDynamicLeft2' );
  var scrollItem3 = document.getElementById( 'decorDynamicBottom' );

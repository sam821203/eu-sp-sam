...
function ScrollDynamicSliderHalf() {
  var scrollItem = document.getElementById( 'decorHalfLeft1' );
  var scrollItem2 = document.getElementById( 'decorHalfLeft2');
  var scrollItem3 = document.getElementById( 'decorHalfRight1');
  var scrollItem4 = document.getElementById( 'decorHalfRight2');
  ...
  window.addEventListener( "scroll", function () {
    ...
    scrollItem4.style.transform = 'translateY(' + pos + '%)';

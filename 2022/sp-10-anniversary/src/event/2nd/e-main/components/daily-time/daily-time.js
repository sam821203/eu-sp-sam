...
function showTimeWrap() {
  // 先抓出有加上active的div
  var productTimeActive = document.querySelectorAll(".product__time.active")

  // 加上相對應的外層
  productTimeActive.forEach(function (item) {
    item.classList.add("product__time--wrap");
  })
...
function scrollDailyTime() {
  ...
  window.addEventListener("scroll", function () {
    ...
    scrollItem2.style.transform = 'translateX(' + pos2 + '%) scale(' + value +')';

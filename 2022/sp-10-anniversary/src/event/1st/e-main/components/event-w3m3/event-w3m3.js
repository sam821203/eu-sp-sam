...
function ScrollEventW3M3() {
  var scrollItem = document.getElementById("decorEventW3M3Center");
  var scrollItem2 = document.getElementById("decorEventW3M3Middle");
  var scrollItem3 = document.getElementById("decorEventW3M3Outer");
  var scrollTitle = document.getElementById("decorEventW3M3Title");

  window.addEventListener("scroll", function () {
    var scrollPercentage = getScrollPercentage(scrollTitle, 0, 0.4);
    var pos = 50 + scrollPercentage * -50;
    // var pos2 = 100 + scrollPercentage * -100;
    var value = scrollPercentage * 1;

    // scrollItem.style.transform = "scaleY(" + value + ")";

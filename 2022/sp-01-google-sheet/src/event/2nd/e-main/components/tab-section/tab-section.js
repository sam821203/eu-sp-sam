  ...
  $.getJSON( dataUrl,
    function ( json ) {
      ...
      $( e ).each( function () {
        ...
        content += '<div class="good__pic"><img src="' + this[4] + '" alt="' + this[1] + '"></div>';
        content += '<div class="good__title">' + this[0] + '</div>';
        content += '<div class="good__name">' + this[1] + '</div>';
        content += '<div class="good__price good__price--original">原價$' + Number( this[2] ).toLocaleString() + '</div>';
        content += '<div class="good__price good__price--now">';
        content += '<span class="price__sign">特價$</span>';
        content += '<span class="price__value">' + Number( this[3] ).toLocaleString() + '</span></div>';
        content += '</li>';

...
import dailyObject from 'event/3rd/e-main/pages/index/index-start-time.js'
...
function scrollDailyTime() {
  ...
  var scrollItem3 = document.getElementById( 'decorDailyTimeStar' );
  var scrollTitle = document.getElementById( 'titleDailyTime' );
  ...
  window.addEventListener( "scroll", function () {
    ...
    scrollTitle.style.transform = 'rotate(' + angle + 'deg) scale(' + value +')';

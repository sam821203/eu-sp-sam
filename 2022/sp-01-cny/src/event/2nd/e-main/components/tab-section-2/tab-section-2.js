...
function scrollTabSectionSecond() {
  var scrollItem = document.getElementById( 'decorTabSectionSecond' );
  ...
  window.addEventListener( "scroll", function () {
    ...
    var pos = 20 + scrollPercentage * -20;
...
function buildTabSecond(){
  var tabBoxSecond = document.getElementById('tabBoxSecond');
  var tabItems = Array.apply(null, tabBoxSecond.querySelectorAll('.tab__item--top'));
...
function buildSliderContent(){
  if(!(dataTabSecond1 && dataTabSecond2 && dataTabSecond3)) return false;

  var dataArray = [dataTabSecond1, dataTabSecond2, dataTabSecond3];

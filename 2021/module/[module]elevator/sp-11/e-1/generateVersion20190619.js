...
(function ($) {
  function buildVersion() {
    ...
    // 正式
    var cssLinkLeft = $(
      '<link type="text/css" href="https://media.etmall.com.tw/sp/7659/main-elevator-left.css?' +
        month + days + min + '" rel="stylesheet">'
    );
    var cssLinkRight = $(
      '<link type="text/css" href="https://media.etmall.com.tw/sp/7659/main-elevator-right.css?' +
        month + days + min + '" rel="stylesheet">'
    );
...
function initBuild(el) {
  ...
  el.append(
    $.getScript(
      'https://media.etmall.com.tw/sp/7659/main-elevator.js?' +
        month + days + min
    )
  );
}

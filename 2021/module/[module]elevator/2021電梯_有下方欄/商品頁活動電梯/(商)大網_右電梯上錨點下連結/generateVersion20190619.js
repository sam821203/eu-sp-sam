...
;(function ($) {
  function buildVersion() {
    ...
    // 正式
    var cssLink = $('<link type="text/css" href="https://media.etmall.com.tw/sp/9991/sp-elevator.css?' + month + days + min + '" rel="stylesheet">');
...
function initBuild(el) {
  ...
  // 正式
  el.append($.getScript("https://media.etmall.com.tw/sp/9991/data-elevator.js"));
  el.append($.getScript("https://media.etmall.com.tw/sp/9991/sp-elevator-downLink.js"));

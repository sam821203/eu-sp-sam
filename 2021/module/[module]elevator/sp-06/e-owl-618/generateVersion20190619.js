...
;(function ($) {
    function buildVersion() {
        ...
        // 正式
        var cssLink = $('<link type="text/css" href="https://media.etmall.com.tw/sp/10006/sp-20190619.css?' + month + days + min + '" rel="stylesheet">');
...
function initBuild(el) {
    ...
    // 正式
    el.append($.getScript("https://media.etmall.com.tw/sp/10006/sp-script20190619.js"));

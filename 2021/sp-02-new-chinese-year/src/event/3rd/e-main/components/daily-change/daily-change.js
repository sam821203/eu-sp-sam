...
function dailyChange() {
    ...
    var dailyDateArray = createDateArray("2021/2/2 10:00:00", 20) // 第二波
...
function addDailyLink(i) {
    ...
    if (!dailyData || i >= 20) return false; // 第一波

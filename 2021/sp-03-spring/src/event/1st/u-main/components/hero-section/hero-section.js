...
function changeMainTitleImage() {
    spTimeLimit("changeAnchor", "changeImg", "2021/04/01 00:00", "title__U__next.png", "");
    spTimeLimit("changeFirstPromo", "changeFirstPromoImg", "2021/04/01 00:00", "promo__U__next-2.png", "https://media.u-mall.com.tw/sp/8454/m/index.html");
}

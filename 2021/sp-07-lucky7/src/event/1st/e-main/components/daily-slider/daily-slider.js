...
function dailySlider() {
  ...
  var arrayDailySliderDate = createDateArray("2021/6/30 10:00:00", 23);
  ...
  if (today__getTime < scheduledOpen__getTime) {
    //- 假資料
    var data_fake = createDateArray("2021/6/28 10:00:00", 2);
    buildByCustomTime(data_fake, [buildSlider, buildNextItem], 100);
  }
  else {
    buildByCustomTime(arrayDailySliderDate, [buildSlider, buildNextItem], 100);
  }
}

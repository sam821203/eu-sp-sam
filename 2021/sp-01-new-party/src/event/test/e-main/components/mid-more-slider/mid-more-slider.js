...
// import { convertSvgImages } from 'utils/js/svg-handle.js'
import { setScrollSvgPath } from 'utils/js/svg-handle.js'

export var initSliderMidMore = [detectApp( window.addEventListener( 'load', sliderMidMoreReady ), sliderMidMoreReady ), setScrollSvgPath('.svg--scroll')];

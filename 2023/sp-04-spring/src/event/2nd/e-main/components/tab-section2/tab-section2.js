  ...
  var tabSlider = new Swiper("#tabSlider2Block", {
    ...
    pagination: {
      ...
      renderBullet: function (index, className) {
        return (
          '<div class="' + className + '">' +
            '<img src="tab2-' + (index + 1)  + '-2' + '.png" alt="第'+ (index + 1)  + '個頁籤" >' +
            '<div class="tab2--top">' +
...
function scrollTabSection2() {
  ...
  var scrollItem2 = document.getElementById( 'decorTab2Bottom');

  window.addEventListener("scroll", function () {
    var scrollPercentage = getScrollPercentage(scrollItem2, 0, 0.35);

    // var pos = 150 + scrollPercentage * -150;
    // var pos2 = 75 + scrollPercentage * -75;

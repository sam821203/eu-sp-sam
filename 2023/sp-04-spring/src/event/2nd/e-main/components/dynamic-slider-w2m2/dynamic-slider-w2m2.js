...
function scrollDynamicSliderW2M2() {
  ...
  var scrollItem2 = document.getElementById( 'decorSliderW2M2Flower' );
  var scrollTitle1 = document.getElementById( 'decorSliderW2M2Title1' );
  var scrollTitle2 = document.getElementById( 'decorSliderW2M2Title2' );

  window.addEventListener( "scroll", function () {
    var scrollPercentage = getScrollPercentage( scrollItem, 0, .25 );
    ...
    if ( scrollPercentage === 1 ) {
      ...
      scrollTitle1.classList.add( 'active' );
      scrollTitle2.classList.add( 'active' );
    } else {
      scrollItem.classList.remove( 'active' );
      scrollTitle1.classList.remove( 'active' );

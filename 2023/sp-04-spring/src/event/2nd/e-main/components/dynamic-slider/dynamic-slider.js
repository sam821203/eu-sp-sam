...
function scrollDynamicSlider() {
  var scrollItem = document.getElementById( 'decorDynamicSliderLeft1' );
  var scrollItem2 = document.getElementById( 'decorDynamicSliderLeft2' );
  var scrollItem3 = document.getElementById( 'decorDynamicSliderRight' );

  window.addEventListener( "scroll", function () {
    var scrollPercentage = getScrollPercentage( scrollItem3, 0, .4 );

    var pos = 100 + scrollPercentage * -100;
    var value = scrollPercentage * 1;

    scrollItem3.style.transform = 'translateX(' + pos + '%) scale(' + value + ')';

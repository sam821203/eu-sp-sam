  ...
  var tabSlider = new Swiper('#tabSliderBlock', {
    ...
    pagination: {
      ...
      renderBullet: function (index, className) {
        return '<div class="' + className + '">' + '<img src="tab-' + (index + 1) + '.png">' + "</div>";
      },
    },
...
function scrollTabSection() {
  var scrollItem = document.getElementById('decorTabLeft');
  var scrollItem2 = document.getElementById('decorTabRight');
  ...
  window.addEventListener("scroll", function () {
    ...
    scrollItem2.style.transform = 'translate(-' + (pos * 3) + '%, ' + pos + '%)';

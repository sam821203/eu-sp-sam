...
function dynamicSliderW3M3Bn() {
  var dynamicSliderW3M3Bn = new Swiper('#dynamicSliderW3M3Bn', {
    autoplay: {
      delay: 2000,
    ...
    //   slideShadows: false,
    // },
    initialSlide: Math.floor(Math.random() * document.querySelectorAll('#dynamicSliderW3M3Bn .swiper-slide').length),
    lazy: {
      loadPrevNext: true,
    },
    loop: true,

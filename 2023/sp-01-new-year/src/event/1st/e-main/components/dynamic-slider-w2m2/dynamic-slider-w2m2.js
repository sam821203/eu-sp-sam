...
function scrollDynamicSliderW2M2() {
  var scrollItem = document.getElementById( 'decorSliderW2M2Item1' );
  var scrollItem2 = document.getElementById( 'decorSliderW2M2Item2' );

  window.addEventListener( "scroll", function () {
    var scrollPercentage = getScrollPercentage( scrollItem, 0, .4 );getScrollPercentage

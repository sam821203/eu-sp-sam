...
function buildBnSectionTime() {
  laterDateHide("2023/03/08 00:00:00", "#bnSectionDate1");
  laterDateShow("2023/03/08 00:00:00", "#bnSectionDate2");
  laterDateHide("2023/03/09 00:00:00", "#bnSectionDate2");
  laterDateShow("2023/03/09 00:00:00", "#bnSectionDate3");
}
...
function scrollBnSection() {
  var scrollItem = document.getElementById( 'decorBnSectionTitle' );
  ...
  window.addEventListener( "scroll", function () {
    ...
    // scrollItem.style.transform = 'scale(' + pos + ')';

...
function changeLink2() {
  var promoChangeLink = Array.apply(null,
    document.querySelectorAll('.js-teampuzzle-link'));

  promoChangeLink.forEach(function(el) {
    var webLink = 'https://www.etmall.com.tw//Activity/dl/teampuzzle';
    var mobileLink = 'https://www.etmall.com.tw//Activity/dl/teampuzzle';
    var appLink = 'etmall://open?pgid=43&tb=0&islogin=1&url=https%3a%2f%2fwww.etmall.com.tw%2fActivity%2fdl%2fteampuzzle';
    var targetLink = makeLink(960, appLink, webLink, mobileLink);
    el.href = targetLink;
  });
}
